...
<link rel="stylesheet" type="text/css" href="${webapp_name}/assets/global/plugins/select2/css/select2.css"/>
...
<link href="${webapp_name}/assets/layout2/css/layout.css" rel="stylesheet" type="text/css"/>
<link id="style_color" href="${webapp_name}/assets/layout2/css/themes/grey.css" rel="stylesheet" type="text/css"/>
<link href="${webapp_name}/assets/layout2/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner container">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="${webapp_name}/assets/layout2/img/logo-default.png" alt="logo" class="logo-default"/>
			</a>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
									<li>
										...
										<span class="photo">
										<img src="${webapp_name}/assets/layout3/img/avatar2.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="${webapp_name}/assets/layout3/img/avatar3.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="${webapp_name}/assets/layout3/img/avatar1.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
					...
					<li class="dropdown dropdown-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle" src="${webapp_name}/assets/layout2/img/avatar3_small.jpg"/>
...
<script src="${webapp_name}/assets/layout2/scripts/layout.js" type="text/javascript"></script>
<script src="${webapp_name}/assets/layout2/scripts/demo.js" type="text/javascript"></script>
<script src="${webapp_name}/assets/global/scripts/datatable.js"></script>
<script src="${webapp_name}/assets/admin/pages/scripts/ecommerce-products.js"></script>
